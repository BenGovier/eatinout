...
export function StripeExpressCheckoutPlaceholder() {
  return (
    <section aria-label="Express payment options" className="flex flex-col gap-3">
      {/* Apple Pay wallet button (visual mock) */}
      <div
        aria-hidden="true"
        className="flex h-12 cursor-pointer items-center justify-center gap-1.5 rounded-xl bg-black text-base font-medium tracking-tight text-white shadow-sm transition-all duration-150 motion-safe:hover:scale-[1.01] motion-safe:hover:shadow-md motion-safe:active:scale-100"
      >
      ...
      <div
        aria-hidden="true"
        className="flex h-12 cursor-pointer items-center justify-center rounded-xl border border-black/10 bg-white text-base font-medium tracking-tight text-[var(--p-ink)] shadow-sm transition-all duration-150 motion-safe:hover:scale-[1.01] motion-safe:hover:shadow-md motion-safe:active:scale-100"
      >
