            ...
            <section id="how-it-works" className="py-12 md:py-20 bg-white">
                <div className="mx-auto max-w-7xl px-4 lg:px-8">
                    ...
                    <div className="text-center mb-10 md:mb-14">
                        ...
                        <p className="text-[#57534E] text-sm md:text-base max-w-md mx-auto">
                            Three simple steps to start saving when you eat out
                        </p>
                    </div>
                    ...
                    <div className="grid gap-6 md:gap-8 md:grid-cols-3 max-w-4xl mx-auto mb-12">
                        {steps.map((step, index) => (
                            <div
                                key={index}
                                className="text-center bg-[#FAF9F7] rounded-2xl p-6 md:p-8 border border-[#E8E4DF]"
                            >
                                <div className="relative inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white text-[#DC3545] mb-4 border border-[#E8E4DF] shadow-sm">
