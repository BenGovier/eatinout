                ...
                <div className="relative mb-10">
                    ...
                    >
                        {featuredRestaurants.map((restaurant, index) => (
                            <div
                                key={index}
                                className="flex-shrink-0 w-[280px] md:w-[300px] snap-start bg-white rounded-2xl shadow-sm border border-[#E8E4DF] overflow-hidden hover:shadow-lg hover:border-[#D6D3D1] transition-all duration-200"
                            >
                                {/* Image with badge */}
                                ...
                                <div className="p-4 md:p-5">
                                    ...
                                    <div className="flex items-center justify-between mt-3 pt-3 border-t border-[#E8E4DF]">
                                        ...
                                        <span className="inline-flex items-center text-[#DC3545] text-sm font-medium cursor-pointer hover:underline">
                                            Show offer in venue
