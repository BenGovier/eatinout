...
//fix reederoffer restaurant name bugs code below
// import { NextResponse } from "next/server"
// import { NextRequest } from "next/server"
// import connectToDatabase from "@/lib/mongodb"
// import { verifyAdminToken } from "@/lib/auth-admin"
...
//     // Get unique associatedIds from offers
//     const associatedIds = [...new Set(offers.map((o: any) => o.associatedId).filter(Boolean))]

//     // Get unique offerRestaurantIds from wallet entries
//     const offerRestaurantIds = [...new Set(
//       walletEntries.map((w: any) => {
//         if (!w.offerRestaurantId) return null
//         return typeof w.offerRestaurantId === 'object'
...
//     const allPossibleIds = [...new Set([...restaurantIdsFromOffers, ...offerRestaurantIds, ...associatedIds])]

//     // Fetch restaurants using all possible IDs and matching fields
//     const restaurants = await Restaurant.find({
//       $or: [
//         { _id: { $in: allPossibleIds } },
//         { associatedId: { $in: allPossibleIds } },
...
//     // Map restaurants by _id, associatedId, and userId for flexible lookup
//     const restaurantMap = new Map()
//     restaurants.forEach((r: any) => {
//       restaurantMap.set(r._id.toString(), r)
//       if (r.associatedId) {
...
//         // Strategy 1: Try offer's restaurantId
//         if (offer?.restaurantId) {
//           restaurant = restaurantMap.get(offer.restaurantId.toString())
//         }

//         // Strategy 2: Try offer's associatedId
//         if (!restaurant && offer?.associatedId) {
//           restaurant = restaurantMap.get(offer.associatedId.toString())
//         }

//         // Strategy 3: Try wallet's offerRestaurantId
//         if (!restaurant && entry.offerRestaurantId) {
//           const restaurantIdStr = typeof entry.offerRestaurantId === 'object'
//             ? entry.offerRestaurantId.toString()
//             : entry.offerRestaurantId
