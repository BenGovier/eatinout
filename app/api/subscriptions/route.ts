...
// cancel functionality update code below
// import { render } from '@react-email/render';
// import sendEmail from "@/lib/sendEmail";
// import SubscriptionCancellationEmail from "@/utils/email-templates/SubscriptionCancellationEmail";
// import { NextResponse } from "next/server";
...
//     console.log("CANCEL API CALLED. User ID:", user._id);
//     console.log("DB user.isTrialing:", user.isTrialing);
//     console.log("Stripe currentSubscription.status:", currentSubscription.status);

//     const isCurrentlyTrialing = user.isTrialing === true || currentSubscription.status === "trialing";
//     console.log("Evaluated isCurrentlyTrialing:", isCurrentlyTrialing);
...
//       } else if (subscription.status === 'canceled') {
//         hasAccess = false;
//         accessReason = `Subscription is cancelled`;
//         effectiveStatus = 'cancelled';
//         user.isTrialing = false;
//       } else if (subscription.status === 'past_due') {
//         // For past due, check if still within period
