                          ...
                          {availablePlans.map((plan) => {
                            ...
                            return (
                              <button
                                ...
                                type="button"
                                onClick={() => setSelectedPriceId(plan.priceId ?? null)}
                                className={`relative flex flex-col items-center rounded-xl py-2.5 px-2 text-sm font-semibold border transition-colors ${isSelected
                              ...
                              >
                                ...
                                {plan.discountLabel && (
                                  <span
                                    className={`mt-0.5 text-[11px] font-bold leading-none ${isSelected ? "text-white" : "text-[#C8102E]"
                                      }`}
                                  >
                                    {plan.discountLabel}
                                  </span>
                              ...
                              {availablePlans.map((plan) => {
                                ...
                                return (
                                  <button
                                    ...
                                    type="button"
                                    onClick={() => setSelectedPriceId(plan.priceId ?? null)}
                                    className={`rounded-full py-2 text-sm font-semibold transition-colors ${isSelected
