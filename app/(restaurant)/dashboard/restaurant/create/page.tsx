...
export default function RestaurantRegisterPage() {
  ...
  const handleAddCuisine = async () => {
    ...
    try {
      ...
      setFormData((prev) => ({ ...prev, category: [...prev.category, newCategory.id] }));
  ...
  // Modify the removeImage function to delete from Azurex
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/restaurant", {
        ...
        // body: JSON.stringify({ ...formData, area: selectedAreas, menuPdfUrl }),
        body: JSON.stringify({ ...formData, area: selectedAreas, menuPdfUrls, searchTags: selectedTags }),
      });
  ...
  return (
    <div className="">
      <div className="mx-2">
        {/* Replace step indicators with tabs */}
        <div className="mb-8">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <span className="text-xs text-gray-500 ">This is the number for bookings and enquiries.</span>
                  </div>
                  <div className="space-y-2">
