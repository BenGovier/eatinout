...
export default function EditOfferPage() {
  ...
  const handleWizardNext = () => {
    ...
    const handleSubmit = async () => {
        if (requiresPremium) {
          toast.error("Please upgrade to premium membership to update this offer. Offers less than 25% or Buy One Get One Free require a premium subscription.")
          return
        }
  ...
  if (loading) {
    return (
        <div className="space-y-6">
          ...
          <h1 className="text-2xl lg:text-3xl font-bold">Edit Offer</h1>
            </div>
                <Card>
      ...
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" onClick={() => router.push("/dashboard/offers")}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle>Edit Your Offer</CardTitle>
        ...
        <CardContent>
          ...
          <div className="flex justify-between pt-6 border-t">
            ...
            >
              {isSubmitting ? "Saving..." : wizardStep === totalSteps ? "Update Offer" : "Next Step"}
