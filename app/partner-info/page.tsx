      ...
      <footer className="bg-gray-900 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <img src="/images/eatinoutlogo.webp" alt="EATINOUT" className="h-8 brightness-0 invert" />
              <span className="text-gray-500 text-sm">© {new Date().getFullYear()} Eatinout. All rights reserved.</span>
            </div>
            <div className="flex gap-6">
              <Link href="/for-restaurants" className="text-gray-400 hover:text-white text-sm transition-colors">
                For Restaurants
              </Link>
